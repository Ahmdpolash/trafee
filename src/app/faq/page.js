              ...
              <ul className="">
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                      <p className="text-gray-700 text-sm">
                        In times when traffic is no longer an issue we believe
                        each advertiser deserves to reach its ideal public.
                        Whether you are looking to develop brand awareness,
                        generate new leads or increase sales. We will make it
                        work for you!! We mix innovating technology, human
                ...
                <li className="text-left mb-10">
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                      <p className="text-gray-700 text-sm">
                        Affiliate marketing is the act of placing creative
                        materials in front of potential consumers in hopes that
                        they will be interested in the product or service and
                        act on that advertising effort. Affiliates make a
                        percentage of the sale for each valid action.
                      </p>
                    </div>
                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                      <svg
                ...
                <li className="text-left mb-10">
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                      <p className="text-gray-700 text-sm">
                        You will qualify for Bi-weekly payments after a month of
                        running traffic. This gives us time to anaylze your
                        traffic and also establish a good relationship with you
                        the affiliate. and we require you make over $2500 every
                        two weeks.
                      </p>
                    </div>
                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                ...
                <li className="text-left mb-10">
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                      <p className="text-gray-700 text-sm">
                        We typically run monthly billing cycles, paying the
                        majority of our affiliates on a net-30 basis. Though we
                        do offer flexibility and pay many of our partners net-15
                        payouts. For our best affiliates, we offer a variety of
                        much faster payment plans - many receive bi-weekly
                        payments.
                      </p>
                    </div>
                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                    ...
                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                      <p className="text-gray-700 text-sm">
                        ...
                        <ul className="flex flex-col space-y-2 mt-2">
                          ...
                          <li>2. Email address is fake</li>
                          <li>
                            {" "}
                            3. IP address used to sign up does not match your
                            location{" "}
                          </li>
                          <li>
                            {" "}
                            4. Uncompleted questions 5. Any fake information 6.
                            You do not answer your phone for review or call back
                          </li>
                        </ul>
                      </p>
                    </div>
                ...
                <li className="text-left mb-10">
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                      <p className="text-gray-700 text-sm">
                        ACH transfers within the US will incur a fee of $3.00
                        USD. International Wire (Outside US) will incur a fee of
                        $35.00 USD) and can take up to 7 days. By selecting this
                        option you agree for these fees to be deducted from your
                        account when each payment is processed. Please ensure
                        suitable and correct payment details are provided. If
                        incorrect, your payments may not be successful and you
                        could be liable for a fee/bank charge.
                      </p>
                    </div>
                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                      <svg
